...
import { 
  Search, MapPin, Building2, User, CheckCircle, Users, Clock, TrendingUp, 
  AlertCircle, Eye, ImageIcon, Briefcase, Star, Award, DollarSign, XCircle 
} from 'lucide-react';
              ...
              <Card key={issue.id} className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    {/* Citizen Image Only (No Resolution Image Yet) */}
                    {issue.imageUrl && !issue.resolutionImageUrl && (
                      <div className="mb-4">
                        <div className="flex items-center gap-2 mb-2">
                          <ImageIcon className="h-4 w-4 text-gray-500" />
                          <span className="text-sm font-medium text-gray-700">Reported Issue Image</span>
                        </div>
