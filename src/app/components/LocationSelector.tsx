      ...
      navigator.geolocation.getCurrentPosition(
        async (position) => {
          ...
          try {
            ...
            setIsDetecting(false);
            alert('Unable to get address from coordinates. Please enter manually.');
          }
        },
        (error) => {
          ...
          if (error.code === error.PERMISSION_DENIED) {
            errorMessage = 'Location access denied. Please enable location permissions and try again, or enter manually.';
